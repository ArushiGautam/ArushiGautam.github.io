...
### Download the Data 
The first step in creating data visualizations is to load the data. We will store the url as a string, and then we will read and store the csv file in a database named penguins.
